...
class Appcolor {
  //0xFF3E54AC
  static Color primarycolor = const Color(0xFF0499db);
  //static Color primarycolor = const Color(0xFF151026);
  static Color textDark = const Color(0xFF242476);
  static Color backgroundColor = const Color(0xFF242476);
  static Color bg = const Color(0xFFDCDCDE);
  ...
  static Color lightAccent = const Color(0xFF242476);
  static Color textPrimary = const Color(0xFF6C04FF);

  static const Color buttonColor = Color(0XFF0499db);
